...
%%% 	module implements a context handler in the
%%% 	{@link //ngap. ngap} application.
%%%
-module(ngap_context_fsm).
-copyright('Copyright (c) 2020 SigScale Global Inc.').

-behaviour(gen_statem).

%% export the ngap_context_fsm API
-export([]).
...
%%----------------------------------------------------------------------
%%  The ngap_context_fsm API
%%----------------------------------------------------------------------

%%----------------------------------------------------------------------
%%  The ngap_context_fsm gen_statem callbacks
%%----------------------------------------------------------------------
